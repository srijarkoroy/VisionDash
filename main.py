...
task = st.sidebar.selectbox("Select the Algorithm that you want to run!", ("Home", "Classification", "Face Detection", "Object Detection", "Instance Segmentation", "Semantic Segmentation"))
